...
public class Main {
    ...
    static final class FastWriter {
        ...
        void printSpace(Object o) { sb.append(o).append(' '); }
    ...
    public static void main(String[] args) throws IOException {
        ...
        long n = fs.nextLong();
        if (n ==1 ) { fw.print(n); fw.flush(); return; }
        if (n ==2 || n ==3) { fw.println("NO SOLUTION"); fw.flush(); return; }
//        for (long i = (n % 2 == 0 ? n : n-1); i >= 2; i-=2) {
//            fw.printSpace(i);
//        }
//        for (long i = (n % 2 ==1 ? n : n-1); i >= 1; i-=2) {
//            fw.printSpace(i);
//        }
